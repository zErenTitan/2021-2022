  ...
  <div class="modal-dialog  " role="document">
    <div class="modal-content">
      ...
      <?php
        ...
        do{
            $cod_serv=$listar['serv_codigo'];
            $serv_nome= $listar['serv_nome'];
            $serv_descr=$listar['serv_descricao'];
            $valor = $listar['serv_valor'];
            echo"<tr>
            <td>$cod_serv</td>
            <td>$serv_nome</td>
            <td>$serv_descr</td>
    ...
    <div id="consulta_prod">
        <form method="GET" autocomplete="off">
            <legend><h3>Consulta de Serviços </h3></legend>
    ...
    <div id="busca">
                ...
                $sql2="select * from servicos where serv_codigo=$codigo_busca";
                $conectar2=mysqli_query($conexao,$sql2);
                if(mysqli_num_rows($conectar2)>0){
                $linha = mysqli_fetch_assoc($conectar2);
                $codigo_da_busca=$linha['serv_codigo'];
                $serv_nome_buscado= $linha['serv_nome'];
                $serv_descr_buscado=$linha['serv_descricao'];
                $valor_buscado = $linha['serv_valor'];
                echo"<br><br>
                <div id='resultado_busca'>
                <form method='POST'>
                Código: <input type='text' name='codigo_anterior' disabled size='1' value='$codigo_da_busca' >
                Nome do Produto: <input type='text' name='novo_nome' size='60vw'  value='$serv_nome_buscado' >
                Descrição do Produto: <input type='text' name='nova_descri'  value='$serv_descr_buscado' >
                <br><br>

                Valor Unidade: <input type='test' name='novo_valor' value = '$valor_buscado'>
                ...
                echo "Produto não encontrado.";
                 ...
                 if($_POST ){
                   ...
                   $sql3 = "update servicos set serv_nome='$novo_nome' , serv_descricao = '$nova_descri', serv_valor = $novo_valor where serv_codigo = $codigo_anterior";
