      ...
      <div class="container">
        ...
        <br>
          <?php
            ...
            include("../conexoes/conexao.php");
            $vagas = "select * from vaga, empresa where vaga.emp_codigo=empresa.emp_codigo";
                  ...
                  <div class='vagas container'>
                    <form method='POST' action='selecionar_vaga.php'>
                      ...
                      <div class='descricoes'> 
                        <input type='text' class='form-control ' name='nome_vaga' readonly value='Nome da Vaga: $NomeVaga'>
                      </div>

                      <div class='descricoes'>
                      <input type='text' name='nome_empresa' class='form-control' readonly value='Nome da Empresa: $nomeempresa'>
                      </div>

                      <div class='descricoes'>
                      <input type='text' name='cidade_vaga' class='form-control' readonly value='Cidade: $Cidade'>
                      </div>
                      ...
                      <div class='descricoes' >
                      <input type='text' name='requisitos' class='form-control' readonly value='Requisitos: $Requisitos'>
                      </div>
                      <div id='botao'>
