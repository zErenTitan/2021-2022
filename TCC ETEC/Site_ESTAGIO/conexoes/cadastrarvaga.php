...
<body>
    <?php
        ...
        $sql=mysqli_query($conexao,"insert into vaga(nom_vaga,emp_codigo,cargo_vaga,requisitos,cidade_vaga,carga_hr_vaga,salario_vaga,descricao_vaga)
        values('$nomvaga','$empcodigo','$cargovaga','$requisitos','$cidvaga','$cargahr','$salvaga','$descricao')") or die ("Cadastro não inserido.");
